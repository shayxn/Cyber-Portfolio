...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 border-b border-primary/20 bg-background/90 backdrop-blur-md">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <a 
                href="/resume.pdf" 
                target="_blank"
                className="px-4 py-2 text-sm font-mono font-bold text-background bg-primary hover:bg-accent hover:text-white transition-colors clip-path-polygon"
        ...
        {isOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <a 
                href="/resume.pdf"
                className="block w-full text-center mt-4 px-4 py-3 text-base font-mono font-bold text-background bg-primary hover:bg-accent"
              >
                DOWNLOAD_RESUME
              </a>
            </div>
