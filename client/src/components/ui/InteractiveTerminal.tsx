      ...
      case "socials":
        output = (
          <div className="space-y-1">
            <div>GitHub: <a href="https://github.com" target="_blank" className="underline hover:text-accent">github.com/user</a></div>
            <div>LinkedIn: <a href="https://linkedin.com" target="_blank" className="underline hover:text-accent">linkedin.com/in/user</a></div>
